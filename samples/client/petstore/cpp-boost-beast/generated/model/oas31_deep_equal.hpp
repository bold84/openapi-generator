// ============================================================================
// oas31_deep_equal.hpp — Wave-1 EXACT deep JSON equality (K-30/K-34/K-22).
//
...
// every JSON number is compared via oas31::ExactNumber so 1 == 1.0 == 1e0
...
// `deepInstanceEqual` lives in oas31_validator.hpp because the instance side
...
// ============================================================================
#ifndef OAS31_DEEP_EQUAL_HPP_
#define OAS31_DEEP_EQUAL_HPP_
